    ...
    <section className='max_padd_container py-20'>
      <div>
        ...
        <div className='flexBetween my-8 mx-2'>
          ...
          <div className='flexBetween max-sm:px-4 gap-x-4 px-8 py-3 rounded-xl ring-1 ring-slate-900/15 max-md:px-4 max-md:py-1 max-md:text-[11px]'>Sort by <MdOutlineKeyboardArrowDown /></div>
        </div>
