    ...
    return (
        <section className='relative bg-hero bg-cover  bg-top bg-no-repeat h-screen w-full max-sm:h-[400px] max-sm:top-10  mb-16'>
            <div className='relative top-40 max-md:top-32 w-[25%] max-sl:w-[35%] m-auto ml-[38%] max-md:pt-[17%]  max-sl:ml-[34%] max-sm:pt-[6%] text-center'>
                ...
                <NavLink to='/mens' className=' bg-white   max-lg:text-[11px] max-md:text-[10px] max-sm:text-[8px]  max-xsl:ml-[-3%] max-xs:ml-[-10%] max-sm: max-lg:mr-1 px-4 py-1 mr-3 font-semibold rounded-sm max-sm:px-3'>MEN</NavLink>
                <NavLink to='/womens' className=' bg-white  max-lg:text-[11px] max-md:text-[10px] max-sm:text-[8px]  max-sm: max-lg:mr-1 px-4 py-1 mr-3 font-semibold rounded-sm max-sm:px-3'>WOMEN</NavLink>
                <NavLink to='/kids' className=' bg-white  max-lg:text-[11px] max-md:text-[10px] max-sm:text-[8px]  max-sm: max-lg:mr-1 px-4 py-1 mr-3 font-semibold rounded-sm max-sm:px-3'>KID</NavLink>
            </div>
        </section>
    )
}
